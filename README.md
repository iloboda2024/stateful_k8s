...
docker build -t stateless-flask:v0 -f task/Dockerfile <context here>
docker login
docker tag stateless-flask:v0 johnyonthespot/stateless-flask:v0
docker push johnyonthespot/stateless-flask:v0
